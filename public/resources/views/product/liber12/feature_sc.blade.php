        ...
        <div class="banner-block">
            ...
            <div class="container">
                <div class="banner-info">
                    ...
                    <div class="h1 banner-header mb-4 mb-sm-5"><div class="d-sm-inline">纤薄轻巧&nbsp</div><div class="d-sm-inline">并非遥不可及</div></div>
                    ...
                    <div class="banner-para ls-0">
                        ...
                        <span class="d-lg-block">最薄之处只有5毫米，重量更轻至1.14千克起，</span>
                    ...
                    <div class="row no-gutters">
                        <div class="col-12 col-lg-5">
                            <div class="banner-info  mx-auto">
                                ...
                                <div class="banner-para ls-0">
                                    ...
                                    <span class="d-lg-block">最高达 8 小时的电池续航力<sup>＊</sup>都能随时回应您使用所需，</span>
                                    <span class="d-lg-block">由早上在社交网路查看第一则动态新闻开始</span>
                                    <span class="d-lg-block">直至晚上下班回家观看电影，都不用连接电源。</span>
                                    <span class="d-lg-block">
                                        <small>* 根据MobileMark 2014  测试长达8个小时 (当关闭Wi-Fi、蓝芽及音频，荧幕亮度设定为20，及设定为省电模式下，电池续航时间可长达10个小时)</small>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="battery-wrap d-flex align-items-center justify-content-center">
                                <div class="badge-caption">最高<span class="badge-value">8</span>小时<br>电池续航力</div>
                            </div>
                            <div class="banner-data d-flex flex-wrap justify-content-center ls-0">
                                <div class="data-card">
                                    <div class="badge-caption">&nbsp;</div>
                                    <div class="badge-value">27.8<span class="badge-caption">瓦时</span></div>
                                    <div class="badge-caption">锂离子电池</div>
                                </div>
                ...
                <div class="container">
                    <div class="banner-info mx-auto ml-lg-0">
                        ...
                        <div class="banner-para ls-0">
                            ...
                            <span class="d-lg-block">带给您最好的舒适度与准确度。LIBER均备有特大触控板以实现直观的操作。</span>
                            <span class="d-lg-block"><small>* 为改善用家于暗光环境下的使用体验，全线12.5"型号均配置背光键盘</small></span>
                        </div>
            ...
            <div class="banner-block">
                ...
                <div class="container">
                    <div class="banner-info mx-auto mr-lg-0">
                        ...
                        <div class="banner-para ls-0">
                            <span class="d-lg-block">无论在何处使用AVITA手提电脑，安全永远是我们最高考量。 AVITA 12.5"完整支援 Windows Hello，可利用指纹辨识来登入系统，透过更方便的安全性装置，无须输入密码也能确保资料在任何情况下皆安全无误。</span>
                        </div>
                ...
                <div class="container">
                    <div class="banner-info mx-auto">
                        ...
                        <div class="banner-para ls-0">
                            ...
                            <span class="d-lg-block">配备BLUETOOTH 4.2及</span>
                            <span class="d-lg-block">802.11 ac Wi-Fi，速度比802.11n快三倍。</span>
                            <span class="d-lg-block"><small>* 12.5"配备一组USB Type-C 连接埠 (附送USB-C转USB + HDMI转接器)</small></span>
